					...
					<div class="row">
						<div class="input-group">
							<div class="form-floating">
								<input type="text" placeholder="title" class="form-control" aria-describedby="button-addon2" id="new-title" bind:value={newStoryTitle} autocomplete="off" on:change={newStory}>
